...
export default function AdminLayout({ children, title = 'لوحة تحكم الأدمن' }) {
    ...
    const navigation = [
        ...
        },
        {
            ...
            description: 'مشاريع العملاء الخارجيين'
        },
        {
            name: 'الموظفين',
        ...
        <div className="min-h-screen bg-gray-50 flex flex-col" dir="rtl">
                            ...
                            <div className="flex items-center space-x-2 sm:space-x-3">
                                ...
                                <div className="hidden xs:block sm:block">
                                    <h1 className="text-xs sm:text-sm font-semibold text-gray-900">
                                        AdManager Pro - {user?.name || 'إدارة النظام'}
                                    </h1>
                        ...
                        <div className="hidden md:flex flex-1 max-w-md mx-8">
                            <div className="relative w-full">
                                <input
                                    type="text"
                                    placeholder="البحث..."
                                    className="w-full pr-10 pl-4 py-2 text-sm border border-gray-200 rounded-lg bg-gray-50 focus:bg-white focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:ring-opacity-20 focus:outline-none transition-all duration-200"
                                />
            ...
            <div className="flex flex-1 overflow-hidden">
                ...
                <aside className={`
                    ...
                    z-40 w-full sm:w-80 md:w-72 lg:w-64 bg-white border-l border-gray-200 shadow-2xl lg:shadow-none transition-transform duration-300 ease-in-out
                `}
