...
export default function Create({ managers }) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('admin.client-projects.store'));
    };

    return (
        <AdminLayout title="إضافة مشروع عميل جديد">
            <Head title="إضافة مشروع عميل جديد" />

            <div className="max-w-4xl mx-auto">
                <div className="bg-white rounded-lg shadow border border-gray-200">
                    <div className="p-6 border-b border-gray-200">
                        <h1 className="text-xl font-semibold text-gray-900">إضافة مشروع عميل جديد</h1>
                        <p className="text-gray-600 mt-1">املأ البيانات التالية لإضافة مشروع عميل جديد</p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="p-6 space-y-6">
                        ...
                        <div className="flex justify-end space-x-3 pt-6 border-t border-gray-200">
                            <button
                                type="button"
                                onClick={() => router.get(route('admin.client-projects.index'))}
